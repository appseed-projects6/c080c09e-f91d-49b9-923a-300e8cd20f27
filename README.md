...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-09-09 10:34`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c080c09e-f91d-49b9-923a-300e8cd20f27.git
$ cd c080c09e-f91d-49b9-923a-300e8cd20f27
```
